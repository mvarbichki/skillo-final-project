...
urlpatterns = [
    ...
    path("movies_management_page", views.movies_management_page, name="movies_management_page"),
    path("favorite_management_page", views.favorite_management_page, name="favorite_management_page")
]
